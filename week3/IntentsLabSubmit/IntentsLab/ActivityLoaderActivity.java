...
public class ActivityLoaderActivity extends Activity {
	...
	private void startImplicitActivation() {
		...
		Uri googleLandingPage = Uri.parse("http://www.google.com");
		Intent webIntent = new Intent(Intent.ACTION_VIEW, googleLandingPage);
		
		Intent chooserIntent = Intent.createChooser(webIntent, "Select an app for viewing the webpage");
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if(resultCode == RESULT_OK && requestCode == GET_TEXT_REQUEST_CODE){
			mUserTextView.setText(data.getStringExtra(ExplicitlyLoadedActivity.SAVED_EXTRA));
		}
    }
}
